            ...
            {activeSection === 'historia' && (
              <section className="mt-12">
                ...
                <p className="text-lg/7 mt-4 text-justify text-black">
                  A formação da Liga Municipal de Futebol de Taubaté (L. M. F.
                  T.) ocorreu através de duas ligas que já existiam na cidade. A
                  Liga de Futebol Norte de São Paulo (L. F. N. S. P.) que
                  congregava as cidades da região do Vale do Paraíba e a Liga
                  Suburbana de Futebol. A fundação da Liga Municipal de Futebol
                  de Taubaté ocorreu em 1942, mas ela se efetivou em 1943.
                  Durante dois anos não foi realizado nenhum campeonato devido à
                  construção do estádio Félix Guisard, atualmente campo da CTI e
                  os Jogos Abertos do Interior, que na ocasião era algo inédito.
                </p>
                <p className="text-lg/7 text-justify text-black">
                  ...
                  Operária Futebol Clube e outros. Era o primeiro fruto da Liga
                  de Futebol Norte de São Paulo. No dia 16 de dezembro de 1941,
                  surgia o futebolista Galdino Marcondes de Rezende, da fazenda
                  Barreiro, trazendo uma ideia nova, a fundação da Liga
                  Suburbana de Futebol.
                </p>
                <p className="text-lg/7 text-justify text-black">
                  Em 1945, o primeiro ano de disputa do campeonato, duas equipes
                  foram campeãs, o Clube Atlético Ceteiense e o E. C. Taubaté
                  que foi o campeão da região sendo o representando do Estado.
                  Mas esse título foi válido apenas pela L. F. N. S. P. O Clube
                ...
                <p className="text-lg/7 text-justify text-black">
                  ...
                  Municipal o projeto de utilidade pública para a fundação de
                  uma entidade de futebol. E o primeiro presidente foi José Luiz
                  de Almeida Soares, que na época era prefeito de Taubaté.
                  Benedito Marcondes Ferreira, presidente que ficou por mais
                  tempo na Liga, mudou a forma como era analisado o futebol
                  amador, tanto que no seu período surgiram várias equipes e o
                  campeonato chegou a contar com três divisões. “Um lutador
                  emérito, batalhador, o homem que carregava sozinho nas costas
                  a Liga de Taubaté”, ressaltou Horton Sidnei Cunha sobre o
                  comportamento de Benedito Marcondes Ferreira. O futebol amador
                  tinha uma ajuda do município, porém a Liga não tinha uma sede
                  própria. A sede da Liga passou por vários locais desde a
                  residência de Benedito Marcondes, a praça D. Epaminondas, R.
                  Pedro Costa, R. Emílio Winther e após várias mudanças, ela se
                  efetivou na Rodoviária Velha de Taubaté.
                </p>
                <p className="text-lg/7 text-justify text-black mb-6">
                  ...
                  Geraldo Vicente de Melo, presidente entre 1993 e 1994 e
                  diretor técnico entre 1994 e 2001, reformulou a estrutura do
                  futebol amador da cidade tornando um dos mais competitivos da
                  região. Devido as mudanças realizadas a Liga Municipal além de
